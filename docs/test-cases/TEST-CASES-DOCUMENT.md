...
| ------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------- |
| Registration completed successfully. User redirected to confirmation page with "Your registration completed" message displayed. | ☑ Pass ☐ Fail | TC001_registration.png |
...
| Actual Result                                                                                               | Status        | Evidence                  |
| ----------------------------------------------------------------------------------------------------------- | ------------- | ------------------------- |
| Error message "The specified email already exists" displayed correctly. User remained on registration page. | ☑ Pass ☐ Fail | TC002_duplicate_email.png |
...
| Actual Result                                                                                                | Status        | Evidence                |
| ------------------------------------------------------------------------------------------------------------ | ------------- | ----------------------- |
| Error message "Wrong email" displayed when invalid email format entered. Registration prevented as expected. | ☑ Pass ☐ Fail | TC003_invalid_email.png |
...
| Actual Result                                                                                                      | Status        | Evidence                    |
| ------------------------------------------------------------------------------------------------------------------ | ------------- | --------------------------- |
| Error message "The password and confirmation password do not match" displayed. User remained on registration page. | ☑ Pass ☐ Fail | TC004_password_mismatch.png |
...
| Actual Result                                                                             | Status        | Evidence                |
| ----------------------------------------------------------------------------------------- | ------------- | ----------------------- |
| Login successful. User email displayed in header and "Log out" link appeared as expected. | ☑ Pass ☐ Fail | TC005_login_success.png |
...
| Actual Result                                                                                                   | Status        | Evidence             |
| --------------------------------------------------------------------------------------------------------------- | ------------- | -------------------- |
| Error message "Login was unsuccessful" with "No customer account found" displayed. User remained on login page. | ☑ Pass ☐ Fail | TC006_login_fail.png |
...
| Actual Result                                                                                      | Status        | Evidence              |
| -------------------------------------------------------------------------------------------------- | ------------- | --------------------- |
| Validation error displayed for empty email field. Login prevented and user remained on login page. | ☑ Pass ☐ Fail | TC007_empty_login.png |
...
| Actual Result                                                                                        | Status        | Evidence         |
| ---------------------------------------------------------------------------------------------------- | ------------- | ---------------- |
| Logout successful. "Log in" and "Register" links reappeared in header. User session ended correctly. | ☑ Pass ☐ Fail | TC008_logout.png |
...
| Actual Result                                                                                         | Status        | Evidence                |
| ----------------------------------------------------------------------------------------------------- | ------------- | ----------------------- |
| Search returned relevant results. "14.1-inch Laptop" product displayed in search results as expected. | ☑ Pass ☐ Fail | TC009_search_laptop.png |
...
| Actual Result                                                                                       | Status        | Evidence                    |
| --------------------------------------------------------------------------------------------------- | ------------- | --------------------------- |
| "No products were found that matched your criteria" message displayed correctly. No products shown. | ☑ Pass ☐ Fail | TC010_search_no_results.png |
...
| Actual Result                                                                                                    | Status        | Evidence               |
| ---------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------- |
| Books category page loaded successfully. Products displayed in grid view with correct breadcrumb "Home / Books". | ☑ Pass ☐ Fail | TC011_browse_books.png |
...
| Actual Result                                                                                                       | Status        | Evidence               |
| ------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------- |
| Price filter applied successfully. Only products under $25.00 displayed. Filter removable via "Remove Filter" link. | ☑ Pass ☐ Fail | TC012_price_filter.png |
...
| Actual Result                                                                                  | Status        | Evidence             |
| ---------------------------------------------------------------------------------------------- | ------------- | -------------------- |
| Products sorted by price low to high correctly. Lowest priced item appeared first in the list. | ☑ Pass ☐ Fail | TC013_sort_price.png |
...
| Actual Result                                                                                                     | Status        | Evidence                 |
| ----------------------------------------------------------------------------------------------------------------- | ------------- | ------------------------ |
| Product detail page loaded with image, title, price, description, and "Add to cart" button. Reviews link visible. | ☑ Pass ☐ Fail | TC014_product_detail.png |
...
| Actual Result                                                                                                   | Status        | Evidence                     |
| --------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------- |
| "The product has been added to your shopping cart" message displayed. Cart count increased and product visible. | ☑ Pass ☐ Fail | TC015_add_simple_product.png |
...
| Actual Result                                                                                                          | Status        | Evidence                   |
| ---------------------------------------------------------------------------------------------------------------------- | ------------- | -------------------------- |
| Configurable product added successfully with selected options. Cart displayed correct configuration and updated price. | ☑ Pass ☐ Fail | TC016_add_configurable.png |
...
| Actual Result                                                                                             | Status        | Evidence             |
| --------------------------------------------------------------------------------------------------------- | ------------- | -------------------- |
| Quantity updated to 3 successfully. Line total and cart subtotal recalculated correctly (unit price × 3). | ☑ Pass ☐ Fail | TC017_update_qty.png |
...
| Actual Result                                                                                            | Status        | Evidence                 |
| -------------------------------------------------------------------------------------------------------- | ------------- | ------------------------ |
| Product removed from cart after checking "Remove" and clicking update. Cart count decreased accordingly. | ☑ Pass ☐ Fail | TC018_remove_product.png |
...
| Actual Result                                                                                                      | Status        | Evidence                |
| ------------------------------------------------------------------------------------------------------------------ | ------------- | ----------------------- |
| Discount code field accepted input. Invalid code showed "The coupon code you entered couldn't be applied" message. | ☑ Pass ☐ Fail | TC019_discount_code.png |
...
| Actual Result                                                                                                          | Status        | Evidence           |
| ---------------------------------------------------------------------------------------------------------------------- | ------------- | ------------------ |
| Checkout page loaded successfully after agreeing to terms. Billing address step displayed and checkout flow proceeded. | ☑ Pass ☐ Fail | TC020_checkout.png |
...
| ------------ | --------------------- | ------------ | ------ | ------ | ------- |
| Dec 16, 2025 | Chamath Madurasinghe  | TC001-TC020  | 20     | 0      | 0       |
| Dec 16, 2025 | Senithi Mathangaweera | TC021-TC040  | 19     | 1      | 0       |
...
| Reviewer      | Lakindu De Silva      | **\_\_\_** | 12/16/2025 |
